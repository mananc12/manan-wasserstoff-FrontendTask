    ...
    <div className="w-72 bg-gray-800 text-white p-4"> {/* Sidebar container */}
      ...
      <ul>
        {files.map((file) => ( // Iterate over files and folders
          ...
          >
            <div
              className={`bg-white text-gray-800 mb-2 p-1 flex justify-between items-center ${file === selectedFolder ? 'bg-gray-600 text-red-400' : ''}`} // Conditional styling for selected folder
